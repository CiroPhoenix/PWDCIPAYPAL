...
while($filas = $resultado_categoria->fetch_assoc()){
...
<tbody>
   ...
   <td><?php echo $filas['Titulo_Categoria']?></td>  
   <td><a href="editar_categoria.php?ID_Categoria=<?php echo $filas['ID_Categoria']?>">Editar</a></td>
