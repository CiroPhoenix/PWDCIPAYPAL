...
$query_total ="SELECT SUM(Costo_Curso) as 'total' FROM curso where Instructor_Curso = $id";
...
<a  class="bg-dark text-white text-center pl-2 pr-2" href="Agregar_Nivel.php?ID_Curso=<?php echo $filas['ID_Curso']?>">Agregar Niveles</a>
<a  class="bg-dark text-white text-center pl-1 pr-1" href="Ventas_Curso_Maestro.php?ID_Curso=<?php echo $filas['ID_Curso']?>">Ventas</a>
  ...
  <div style="color:white;"class="total">

<h5>Total de Ingresos: $<?php echo $caja?></h5> 

</div>


<h5 style="color:white">Forma de Pago Paypal Unicamente</h5>
