...
?>
    ...
    <td><?php echo $filas['Titulo_Curso']?></td>
     ...
     <a  href="eliminar_carrito.php?ID_Curso=<?php echo $filas['ID_Curso']?>">
            <img src="img/eliminar.png" alt="logo" width="50px">
          </a>
...
?>
    ...
    <button class="btn btn-primary" type="button">Proceder Pago</button>
